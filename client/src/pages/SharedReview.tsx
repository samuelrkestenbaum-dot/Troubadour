    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center text-xs text-muted-foreground py-4">
          <p>Generated by <a href="/" className="font-semibold text-primary hover:underline">Troubadour</a> on {new Date(data.createdAt).toLocaleDateString()}</p>
          <p className="mt-1">AI-powered music critique</p>
        </div>
      </div>
    </div>
  );
